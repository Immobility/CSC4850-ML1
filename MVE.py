...
df_results.to_csv('KNNData1Results.csv', header=False, index=False)
...
df_results = imputer.fit_transform(df)
df_results = pd.DataFrame(df_results)
df_results.to_csv('KNNData2Results.csv', header=False, index=False)
...
df_results = imputer.fit_transform(df)
df_results = pd.DataFrame(df_results)
df_results.to_csv('KNNData3Results.csv', header=False, index=False)